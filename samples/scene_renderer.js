...
SceneRendererSample.prototype.initialize = function () {
	...
	GG.Loader.loadJSON('teapot', '../assets/models/teapot.js', function(jsonObj) {
			this.jsonMesh          = new GG.TriangleMesh(GG.Geometry.fromJSON(jsonObj));
			this.jsonMesh.setPosition([0.0, 1.0, 15.0]);
			this.jsonMesh.setScale([0.5, 0.5, 0.5]);
			this.jsonMesh.material = new GG.PhongMaterial();
			testScene.addObject(this.jsonMesh)				
		}, 
		function () {
	...
	testScene.addObject(this.planeMesh)
